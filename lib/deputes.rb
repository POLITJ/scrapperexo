...
def get_emails
  i = -1
  emails = []
  # Instead of 3 put get_url.size in order to get the full list of 577 deputies ;)  ==============================================
    while i < 3 do
      i += 1
...
def combine
  test = []
  i = 0
  # In order to get the full list of 577 deputies replace 3 by get_first_names.size ==============================================
    while i < 3 do
      i += 1
